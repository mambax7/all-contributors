...
title: "How to Use the Bot: Tips for Repository Maintainers"
...
<Aside type="tip">
If your project is configured for [the @all-contributors bot 🤖](/bot/overview) simply write a comment on an issue or pull request to recognise their contribution. For example:

> `@all-contributors please add @tbenning for design` ✨
</Aside>

## Encourage contributors to add themselves using the bot
...
but it may be necessary for you to add the contributor yourself.

<Aside type="tip">
It's a good idea to do so in the form of a pull
