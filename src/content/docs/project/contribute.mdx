...
The all-contributors bot lives in the [app repository here:](https://github.com/all-contributors/all-contributors-bot)

And the all-contributors CLI lives in the [cli repository here:](https://github.com/all-contributors/all-contributors-cli)
