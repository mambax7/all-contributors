...
description: Learn how to configure the All Contributors bot using the `.all-contributorsrc` JSON file.
sidebar:
  label: Configuration
---
...
> You are viewing the 🤖Bot Configuration, which is similar to the [CLI Configuration](/en/cli/configuration)
...
| `commitConvention`               | Commit convention ([`angular`](https://github.com/angular/angular/blob/main/CONTRIBUTING.md#commit), [`atom`](https://github.com/atom/atom/blob/main/CONTRIBUTING.md#git-commit-messages), or `none`).                                       | Default: `angular`                                                                                          |
| `commitType`                     | Set the `type` for the commit in your chosen `commitConvention` (read more at [Conventional Commits specification](https://www.conventionalcommits.org/en/v1.0.0/#summary).                                                                  | Default: `docs`                                                                                             |
...
| `contributors`                   | List of contributors for this project, this is updated by [@all-contributors add](/en/bot/usage#all-contributors-add)                                                                                                                        |                                                                                                             |
...
1. Install the bot. See the [Installation](/en/bot/installation) page for instructions.
2. Add your first contributor. See the [Bot Usage](/en/bot/usage) page for instructions.
3. Create the `CONTRIBUTORS.md` file.
4. Copy the code which can be found in [this guide](/en/bot/installation).
