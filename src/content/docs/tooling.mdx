...
If you prefer command-line tools, you can instead use the all-contributors CLI tool to help automate adding contributor acknowledgements. [Read more about the All-Contributor bot CLI here](/cli/overview).
